package zerotoonecom.n17r.mubr.Settings;
...
/**
 * Created by Nurdaulet Yeltayev (yeltayev22) on 02.08.2017.
 */
...
public class SettingsFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Preference help = (Preference) getPreferenceManager().findPreference(getString(R.string.help_key));
        ...
        azan.setNegativeButtonText(getString(R.string.cancel));
        azan.setPositiveButtonText(getString(R.string.ok));
        city.setNegativeButtonText(getString(R.string.cancel));
        city.setPositiveButtonText(getString(R.string.ok));
        lang.setNegativeButtonText(getString(R.string.cancel));
        lang.setPositiveButtonText(getString(R.string.ok));
        ...
        help.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto","nurdaulet.97@gmail.com", null));
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.help));
