...
import zerotoonecom.n17r.mubr.data.Event;
import zerotoonecom.n17r.mubr.data.EventAdapter;
...
public class CalendarActivity extends AppCompatActivity {
    ...
    private void addEvents() {
        ...
        events.add(new Event(getString(R.string.event7_month_short), getString(R.string.event7_day_short),
                getString(R.string.event7_week_short), getString(R.string.event7_name),
                getString(R.string.event7_hijri_date), getString(R.string.event7_grig_date), getString(R.string.event7_info), false));

        events.add(new Event(getString(R.string.event8_month_short), getString(R.string.event8_day_short),
                getString(R.string.event8_week_short), getString(R.string.event8_name),
                getString(R.string.event8_hijri_date), getString(R.string.event8_grig_date), getString(R.string.event8_info), false));

        // Today before Arafa
        if (((month < 7) || (month == 7 && day < 31)) && position == 0) {
        ...
        // Qurban 2
        if (month == 8 && day == 2) {
            events.add(new Event(getString(R.string.event11_month_short), getString(R.string.event11_day_short),
                    getString(R.string.event11_week_short), getString(R.string.event11_name),
                    getString(R.string.event11_hijri_date), getString(R.string.event11_grig_date), getString(R.string.event11_info), true));
            position = 10;
        } else {
            events.add(new Event(getString(R.string.event11_month_short), getString(R.string.event11_day_short),
                    getString(R.string.event11_week_short), getString(R.string.event11_name),
                    getString(R.string.event11_hijri_date), getString(R.string.event11_grig_date), getString(R.string.event11_info), false));
        }

        // Qurban 3
        if (month == 8 && day == 3) {
            events.add(new Event(getString(R.string.event12_month_short), getString(R.string.event12_day_short),
                    getString(R.string.event12_week_short), getString(R.string.event12_name),
                    getString(R.string.event12_hijri_date), getString(R.string.event12_grig_date), getString(R.string.event12_info), true));
            position = 11;
        } else {
            events.add(new Event(getString(R.string.event12_month_short), getString(R.string.event12_day_short),
                    getString(R.string.event12_week_short), getString(R.string.event12_name),
                    getString(R.string.event12_hijri_date), getString(R.string.event12_grig_date), getString(R.string.event12_info), false));
        }

        // Qurban 4
        if (month == 8 && day == 4) {
            events.add(new Event(getString(R.string.event13_month_short), getString(R.string.event13_day_short),
                    getString(R.string.event13_week_short), getString(R.string.event13_name),
                    getString(R.string.event13_hijri_date), getString(R.string.event13_grig_date), getString(R.string.event13_info), true));
            position = 12;
        } else {
            events.add(new Event(getString(R.string.event13_month_short), getString(R.string.event13_day_short),
                    getString(R.string.event13_week_short), getString(R.string.event13_name),
                    getString(R.string.event13_hijri_date), getString(R.string.event13_grig_date), getString(R.string.event13_info), false));

        }

        // Today before Hijri NY
        if (((month < 8) || (month == 8 && day < 21)) && position == 0) {
            events.add(new Event(strMonth, String.valueOf(day),
                    strWeek, getString(R.string.today), String.valueOf(hijriDate), strGrig, getString(R.string.today), true));
            position = 13;
        }
        ...
        if (((month < 8) || (month == 8 && day < 30)) && position == 0) {
            events.add(new Event(strMonth, String.valueOf(day),
                    strWeek, getString(R.string.today), String.valueOf(hijriDate), strGrig, getString(R.string.today), true));
            position = 14;
        }
        ...
        // Today before Mawlid
        if (((month < 10) || (month == 10 && day < 30)) && position == 0) {
            events.add(new Event(strMonth, String.valueOf(day),
                    strWeek, getString(R.string.today), String.valueOf(hijriDate), strGrig, getString(R.string.today), true));
            position = 15;
        }
